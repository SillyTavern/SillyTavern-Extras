...
if "chromadb" in modules:
    ...
    if args.chroma_host is None:
        if args.chroma_persist:
            chromadb_client = chromadb.PersistentClient(persist_directory=args.chroma_folder, chroma_db_impl='duckdb+parquet', settings=Settings(anonymized_telemetry=False))
