...
**You need to run the lastest development version of TavernAI. Grab it here: [Direct link to ZIP](https://github.com/SillyLossy/TavernAI/archive/refs/heads/dev.zip), [Git repository](https://github.com/SillyLossy/TavernAI/tree/dev)**
